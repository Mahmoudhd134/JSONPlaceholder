...
const User = () => {
    ...
    return (
        <div className={'container'}>
            ...
            <div className={'row justify-content-center'}>@{user.username}</div>
            ...
            <div className={'row justify-content-center'}>
                <div className={'d-flex justify-content-between w-50'}><span>street:</span> {user.address.street}</div>
            </div>
            <div className={'row justify-content-center'}>
                <div className={'d-flex justify-content-between w-50'}><span>suite:</span> {user.address.suite}</div>
            </div>
            <div className={'row justify-content-center'}>
            ...
            <div className={'row justify-content-center'}>
                <div className={'d-flex justify-content-between w-50'}><span>lat:</span> {user.address.geo.lat}</div>
            </div>
            <div className={'row justify-content-center'}>
                <div className={'d-flex justify-content-between w-50'}><span>lng:</span> {user.address.geo.lng}</div>
            </div>
            ...
            <div className={'row justify-content-center'}>
                <div className={'d-flex justify-content-between w-50'}><span>website</span> <a target={'_blank'} href={'https://www.'+user.website}>click here</a>
                </div>
            </div>
        </div>
    );
